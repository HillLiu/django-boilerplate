...
import {
    PageHeader as LandingPageHeader
} from 'pmvc_react_landing';
...
const PageHeaderContainer = props =>
{
    ...
    return (
        ...
        {({tradeDefaultUrl, brandName, section})=> {
            ...
            let thisNav
            if (isRenderNav) {
                thisNav = <Section name="pageHeaderNav"><PageNav className="pure-u-1 pure-u-lg-4-5" {...props} /></Section>
            }
        return (
        <HorizontalToVerticalMenu
            ...
            atom="header"
            brand={
                <Brand brandName={brandName} className="pure-u-1-2 pure-u-lg-1-5" {...props} />
            }
            nav={ thisNav }
            height={73}
